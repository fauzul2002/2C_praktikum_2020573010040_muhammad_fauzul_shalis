    ...
    <body>
        <html>
            <head>
                ...
                <center><b>FORM BIODATA MAHASISWA/I</B></center>
                <hr>
                <body>
                <table border=0>
                <tr>
                ...
                <option value="4">4</option></td></select>
                </tr>
                <td>Kelas</td>
                <td>:</td>
                <td><select name="RW">
                ...
                <td>:</td>
                <td>
                <input type=radio name="jurusan" value="TIK">Teknologi informasi dan komputer
                </td>
                </tr>
                <tr>
                ...
                <option value="TIK dan TS">Gmail.com</option>
                <option value="TE dan TM">Yahoo.com</option>
                <option value="TANIA dan TK">Yahoo.co.id</option>
                </select> </td>
                </tr>
                <tr>
                <td> </td>
                <td> </td>
                <td><a href="terimakasih.html"><input type="submit" name="Submit" value="Submit"> </a>
